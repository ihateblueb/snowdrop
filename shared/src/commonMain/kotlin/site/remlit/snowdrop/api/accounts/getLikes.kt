...
suspend fun getLikes(
	...
	offset: Int? = null,
	minId: String? = null,
): ApiResponse<List<Status>> = safeApiRequest { accountId, host ->
	val token = settings.getString("account_${accountId}_token", "")

	val urlString = if (userId != null) {
		"https://$host/api/v1/pleroma/accounts/$userId/favourites"
	} else {
		"https://$host/api/v1/favourites"
	}

	val req = httpClient.get(urlString) {
