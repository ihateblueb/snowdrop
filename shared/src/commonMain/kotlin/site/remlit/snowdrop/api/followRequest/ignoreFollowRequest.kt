...
suspend fun ignoreFollowRequest(id: String): ApiResponse<Relationship> = safeApiRequest { accountId, host ->
	val token = settings.getString("account_${accountId}_token", "")

	val req = httpClient.post("https://$host/api/v1/follow_requests/$id/ignore") {
