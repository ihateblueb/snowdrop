...
import site.remlit.snowdrop.model.StatusSource
...
suspend fun getStatusSource(id: String): ApiResponse<StatusSource> = safeApiRequest { accountId, host ->
	val token = settings.getString("account_${accountId}_token", "")

	val req = httpClient.get("https://$host/api/v1/statuses/$id/source") {
