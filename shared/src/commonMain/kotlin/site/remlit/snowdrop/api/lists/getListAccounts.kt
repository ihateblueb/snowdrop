package site.remlit.snowdrop.api.lists
...
suspend fun getListAccounts(id: String): ApiResponse<ApiList> = safeApiRequest { accountId, host ->
	val token = settings.getString("account_${accountId}_token", "")

	val req = httpClient.get("https://$host/api/v1/lists/$id/accounts") {
